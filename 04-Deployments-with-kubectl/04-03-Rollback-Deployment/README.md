...
- **Observation:** If we rollback, it will go back to revision-2 and its number increases to revision-3
```
# Undo Deployment
...
- **Observation:** If we rollback to revision 2, it will go back to revision-2 and its number increases to revision-4 in rollout history
```
# List Deployment Rollout History
kubectl rollout history deployment/my-first-deployment  
```
