...
kubectl set image deployment/my-first-deployment kojitechs-app=kojibello/kojitechs-app:v4.0.0 --record=true
...
kubectl set resources deployment/my-first-deployment -c=kojitechs-app --limits=cpu=20m,memory=30Mi
```
### Resume Deployment 
```
