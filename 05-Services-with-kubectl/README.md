...
Docker Image Reference [kube-helloworld](https://hub.docker.com/repository/docker/kojibello/back-end-helloworld-app/general)
...
```
- **Docker Image Location:** https://hub.docker.com/repository/docker/kojibello/kube-frontend-nginx/general
- **Frontend Nginx Reverse Proxy Application Source** [kube-frontend-nginx](../00-Docker-Images/03-kube-frontend-nginx)
```
# Create Deployment for Frontend Nginx Proxy
kubectl create deployment my-frontend-nginx-app --image=kojibello/kube-frontend-nginx:v1.0.0
kubectl get deploy
